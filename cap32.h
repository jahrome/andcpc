...
#define CPC_RENDER_FIT_WIDTH    3
#define CPC_RENDER_FIT_HEIGHT   4
#define CPC_RENDER_X125         5
#define CPC_RENDER_X15          6
#define CPC_LAST_RENDER         6
...
typedef struct {
   ...
   int           cpc_render_delta_y;
   unsigned char psp_reverse_analog;
   unsigned char psp_irdajoy_type;
   unsigned char psp_irdajoy_debug;
   int           cpc_speed_limiter;
   char          cpc_homedir[MAX_PATH + 1];
   int           cpc_auto_fire;
